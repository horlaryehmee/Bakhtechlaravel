...
class InvoiceController extends Controller
{
    ...
    private function invoiceEmailHtml(object $document, string $templateKey, string $openToken, ?string $receiptReference = null): string
    {
        ...
        $logoUrl = htmlspecialchars($this->absoluteUrl((string) ($branding['logoUrl'] ?: '/uploads/a709e85a-a31b-4585-9b2c-1f45fe5487af.png')), ENT_QUOTES, 'UTF-8');
...
HTML;
    ...
    private function branding(array $branding): array
    {
        ...
        $defaults = [
            ...
            'logoUrl' => $settings['company_logo'] ?? '/uploads/a709e85a-a31b-4585-9b2c-1f45fe5487af.png',
            'primaryColor' => '#ef4444',
            'accentColor' => '#12c8a0',
