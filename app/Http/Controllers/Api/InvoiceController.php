...
class InvoiceController extends Controller
{
    ...
    private function invoiceEmailHtml(object $document, string $templateKey, string $openToken, ?string $receiptReference = null): string
    {
        ...
        $logoUrl = htmlspecialchars($this->absoluteUrl((string) ($branding['logoUrl'] ?: '/uploads/d33c8e05-c4ed-494c-b586-0c426860b6a9.jpg')), ENT_QUOTES, 'UTF-8');
...
HTML;
    ...
    private function branding(array $branding): array
    {
        ...
        $defaults = [
            ...
            'logoUrl' => $settings['company_logo'] ?? '/uploads/d33c8e05-c4ed-494c-b586-0c426860b6a9.jpg',
            'primaryColor' => '#ef4444',
            'accentColor' => '#12c8a0',
