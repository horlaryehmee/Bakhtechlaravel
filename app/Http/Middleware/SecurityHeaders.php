...
class SecurityHeaders
{
    public function handle(Request $request, Closure $next)
    {
        ...
        $response->headers->set('Content-Security-Policy', implode('; ', [
            ...
            "frame-src 'self' https://www.googletagmanager.com https://www.youtube.com https://www.youtube-nocookie.com https://code.tidio.co https://*.tidio.co https://*.tidiochat.com https://*.smartsupp.com https://*.smartsuppchat.com",
        ]));
