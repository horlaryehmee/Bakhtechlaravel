...
function HeroGeometric({
  ...
  return (
    <div className={cn('relative flex min-h-screen w-full items-center justify-center overflow-hidden', className)}>
      ...
      <div className="container-x relative z-20 -translate-y-8 pb-0 md:translate-y-16 md:pb-[18vh]">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <motion.div custom={1} variants={fadeUpVariants} initial="hidden" animate="visible">
            <h1 className="text-main mb-4 text-[2.8rem] font-black leading-[0.96] tracking-tight sm:text-6xl md:mb-6 md:text-8xl">
      ...
      <AnimatedImageMarquee
        ...
        duration={48}
        className="bottom-[8.25rem] z-10 h-[15vh] opacity-82 md:bottom-4 md:h-[25vh]"
      />
